...
def read(text):
    ...
    for line in text.split('\n'):
        ...
        if not '=' in line:
            dirs = list(0 if c == 'L' else 1 for c in line)
        else:
...
def solve2(text):
    ...
    res = 1
    for c in endNodes:
        res = least_common_denominator(res, c)
...
# is won't finish.
# should use least common denominator somehow...
# problem: the end path can be met multiple times in the cycle.